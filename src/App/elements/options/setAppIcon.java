...
public class setAppIcon {
	...
	public setAppIcon(){
		...
		IconSelector.setBounds(90,85,30,30);
		...
		iconDir.setBounds(130,90,300,25);
		iconDir.setBackground(Theme.SecondaryColor);
		iconDir.setForeground(Theme.textColor);
		iconDir.setBorder(null);
		Border b4 = iconDir.getBorder();
		Border b5 = BorderFactory.createMatteBorder(0, 0, 1, 0, Color.black);
		Border b6 = BorderFactory.createCompoundBorder(b5, b4);
		iconDir.setBorder(b6);
