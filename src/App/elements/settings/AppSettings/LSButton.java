...
public class LSButton extends Component {
	...
	public void createLShortcut() {
		try {
			CreateCreatorLShortcut.createLShortcut();
		} catch (IOException e) {
	...
	public void removeLShortcut() {
		if(CreateCreatorLShortcut.LShortcut.exists()) {
		CreateCreatorLShortcut.removeLShortcut();
		}
	}
