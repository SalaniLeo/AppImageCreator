...
public class Borders {
    ...
    public static Border leftBorder = newLeftBorder;
	   ...
	   public static Border rightBorder = newRightBorder;
		     ...
		     static Border oldB = null;
		     static Border brder3 = BorderFactory.createMatteBorder(0, 0, 3, 0, Color.black);
		     static Border newBrder = BorderFactory.createCompoundBorder(brder3, oldB);
		     public static Border BoldBorder = newBrder;
