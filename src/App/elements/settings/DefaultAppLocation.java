...
public class DefaultAppLocation {
	...
	public DefaultAppLocation(){
		...
		if(SettingsLoader.defaultLocationOn == true) {
			
			LocationSelector.setText(SettingsLoader.defaultLocation);
			
		}
		LocationSelector.setBounds(260,130,188,20);
		...
		Location.setBounds(10,130,220,20);
		...
		Browse.setBounds(220,130,27,27);
